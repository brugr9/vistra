...
% Other Packages (added by brugr9)
%---------------------------------------------------------------------------
...
% Requirements
\include{kapitel/vision} 	% Vision
\include{kapitel/usecases} 	% Use Cases
\include{kapitel/suppspec} 	% Supplementary Specification, Domain Rules
% Design
\include{kapitel/domainmodel} 	% Domain Model, Design Model
\include{kapitel/designmodel} 	% Design Model: diagrams
\include{kapitel/architecture} % Software Architecture Document, Data Model
% Project Management
\include{kapitel/projectmanagement} % Time Management, Development Environment Description
