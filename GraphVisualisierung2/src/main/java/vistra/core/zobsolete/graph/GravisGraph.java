...
/**
 * An adapted JUNG graph decorator.
 * 
 * @author Patrick Kofmel (kofmp1@bfh.ch)
 * 
 */
public class GravisGraph extends GraphDecorator<IVertex, IEdge> implements
		IGravisGraph {
	 ...
	 */
	public GravisGraph(Graph<IVertex, IEdge> delegate) {
		super(delegate);
