package vistra.core.graph.zobsolete.item;
...
public abstract class AbstractGraphItem implements IGraphItem {
	...
	public void setCurrentColor(Color color) {
		...
		this.visible = color != VistraColor.WHITE;
	}
	...
	public void setNewColor(Color newColor) {
		if (newColor != VistraColor.WHITE) {
			this.oldColor = newColor;
		}

		this.newColor = newColor;
		this.visible = newColor != VistraColor.WHITE;
	}
	...
	public void setVisible(boolean visible) {
		...
		this.newColor = visible ? this.oldColor : VistraColor.WHITE;
	}
