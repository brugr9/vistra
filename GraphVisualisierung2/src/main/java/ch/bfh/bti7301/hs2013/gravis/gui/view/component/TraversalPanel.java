...
import static ch.bfh.bti7301.hs2013.gravis.gui.control.IControl.EventSource.BACKWARD;
import static ch.bfh.bti7301.hs2013.gravis.gui.control.IControl.EventSource.FORWARD;
import static ch.bfh.bti7301.hs2013.gravis.gui.control.IControl.EventSource.I18N;
import static ch.bfh.bti7301.hs2013.gravis.gui.control.IControl.EventSource.PAUSE;
import static ch.bfh.bti7301.hs2013.gravis.gui.control.IControl.EventSource.PLAY;
import static ch.bfh.bti7301.hs2013.gravis.gui.control.IControl.EventSource.STOP;
import static ch.bfh.bti7301.hs2013.gravis.gui.control.IControl.EventSource.TO_BEGINNING;
import static ch.bfh.bti7301.hs2013.gravis.gui.control.IControl.EventSource.TO_END;
...
public final class TraversalPanel extends JPanel implements Observer {
	...
	public TraversalPanel(IModel model, int width, int height) {
		...
		this.progressBar.setBackground(GravisColor.DARK_GRAY);
		this.progressBar.setForeground(GravisColor.LIGHT_GREEN);
