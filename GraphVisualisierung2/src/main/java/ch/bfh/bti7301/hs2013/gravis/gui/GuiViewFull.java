 ...
 * 
 */
public class GuiViewFull extends JFrame implements IGuiView {
	 ...
	 */
	public GuiViewFull(GuiModel guiModel, GuiControl guiControl, int width,
			int height) {
		...
		this.protocolPanel = GuiFactory
				.createProtocolPanel(guiModel, width, 30);
