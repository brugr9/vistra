...
public abstract class AbstractGraphItem implements IGraphItem {
	...
	public void setCurrentColor(Color color) {
		...
		this.visible = color != TravisColor.WHITE;
	}
	...
	public void setNewColor(Color newColor) {
		if (newColor != TravisColor.WHITE) {
			this.oldColor = newColor;
		}

		this.newColor = newColor;
		this.visible = newColor != TravisColor.WHITE;
	}
	...
	public void setVisible(boolean visible) {
		...
		this.newColor = visible ? this.oldColor : TravisColor.WHITE;
	}
