...
import travis.core.graph.IObservableGravisGraph;
import travis.core.graph.item.edge.IEdge;
import travis.core.graph.item.vertex.IVertex;
import travis.core.traversal.Traversal;
import travis.gui.Model;
import travis.gui.control.IControl.EventSource;
import travis.gui.util.SingleRootFileSystemView;

import edu.uci.ics.jung.graph.event.GraphEvent;
import edu.uci.ics.jung.graph.util.EdgeType;

import static travis.gui.control.IControl.EventSource.ALGORITHM;
import static travis.gui.control.IControl.EventSource.DELETE_ALGORITHM;
import static travis.gui.control.IControl.EventSource.EDIT_GRAPH;
import static travis.gui.control.IControl.EventSource.GRAPH;
import static travis.gui.control.IControl.EventSource.IMPORT_ALGORITHM;
import static travis.gui.control.IControl.EventSource.NEW_GRAPH_DIRECTED;
import static travis.gui.control.IControl.EventSource.NEW_GRAPH_UNDIRECTED;
import static travis.gui.control.IControl.EventSource.OPEN_GRAPH;
import static travis.gui.control.IControl.EventSource.SAVE_GRAPH;
import static travis.gui.control.IControl.EventSource.SAVE_GRAPH_AS;
