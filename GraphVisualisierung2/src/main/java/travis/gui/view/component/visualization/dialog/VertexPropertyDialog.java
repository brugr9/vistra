package travis.gui.view.component.visualization.dialog;
...
import travis.gui.util.GraphItemIdVerifier;
import travis.gui.util.VertexSizeVerifier;
import travis.util.transformer.ValueTransformer;
